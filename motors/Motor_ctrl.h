...
#define SPEED_CTRL_DEFAULTS {0, 0, 0, 0, 0, 0, -0.95, 0.95, SPEED_CTRL_C0, SPEED_CTRL_C1}
#define CURRENT_CTRL_ID_DEFAULTS {0, 0, 0, 0, 0, 0, -0.43, 0.43, CURRENT_CTRL_C0, CURRENT_CTRL_C1}
#define CURRENT_CTRL_IQ_DEFAULTS {0, 0, 0, 0, 0, 0, -0.9, 0.9, CURRENT_CTRL_C0, CURRENT_CTRL_C1}
